...
function name)to replace the existed function called get_fibonacci_partial_sum_naive
*/
...
// Correct output:
// 2
//  (Time used: 0.00/1.00, memory used: 9322496/536870912.)